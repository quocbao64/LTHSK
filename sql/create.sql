...
INSERT INTO [dbo].[Orders]([ID],[OrderDate],[TotalPrice],[DisCount],[UsersID]) VALUES
		   ...
		   (1002,'2022-11-10',200000,0,2),
		   (1003,'2022-11-10',300000,0,2),
		   (1004,'2022-11-10',400000,0,2),
		   (1005,'2022-11-11',300000,0,12),
		   (1006,'2022-11-11',200000,0,5),
		   (1007,'2022-11-11',100000,0,8),
		   (1008,'2022-11-11',100000,0,8),
		   (1009,'2022-11-12',500000,0,8),
		   (1010,'2022-11-12',400000,0,12),
		   (1011,'2022-11-12',200000,0,11),
		   (1012,'2022-11-13',300000,0,4),
		   (1013,'2022-11-13',700000,0,9),
		   (1014,'2022-11-13',200000,0,3),
		   (1015,'2022-11-14',900000,0,5)
